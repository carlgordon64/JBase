...
<div style=' text-align:center; width:100%;'><div id='filters' style='margin-top:-40px;'>  
<button class='button allbtn' data-filter='*'><p>All</p> <div class='button-tag'></div></button>
  <button class='button webbtn' data-filter='.website'><p>Web</p><div class='button-tag'></div></button>
  <button class='button techbtn' data-filter='.tech'><p>Tech</p>  <div class='button-tag'></div></button>
  <button class='button mediabtn' data-filter='.Media'><p>Media</p>  <div class='button-tag'></div></button>
</div></div>
  <!--loop project tiles-->
...
<!-- element item -->
  ...
  <div class='category-label'><p>web</p></div>
...
<!-- element item -->
  ...
  <div class='element-panel-bottom'>
  <div class='category-label'><p>tech</p></div>
  <a href='#'><span class='viewpj'><div class='eyeball'><img alt='Projects' id='eye-icon' class='svg' src='svg/private-eye.svg'/></div></a></span>
  <p class='element-text'>Project One was a project built with tools, made to solve a specific problem.</p>
  </div>
  </div>
